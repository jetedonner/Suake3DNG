...
class RPGRocketBlast:BulletBase{

    var hasDetonated:Bool = false
    let blastRescaleFactor:CGFloat = 62.0
    let blastRescale:SCNVector3 = SCNVector3(62.0, 62.0, 62.0)
...
//        return false
    ...
    public func detonateRocket(pos:SCNVector3){
